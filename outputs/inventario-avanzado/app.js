const STORAGE_KEY = "inventario_avanzado_v1";
  ...
  items: [
    {
      ...
      quantity: 1,
      minStock: 1,
      location: "Mesa de soporte",
      assignedTo: "Mariana López - Finanzas",
      status: "Asignado",
      notes: "Incluye cargador original y bolsa de transporte.",
      updatedAt: new Date().toISOString(),
    },
    {
      id: crypto.randomUUID(),
      code: "CPU-003",
      name: "CPU HP ProDesk 400 G7",
      type: "Activo",
      category: "CPU",
      brand: "HP",
      model: "ProDesk 400 G7",
      serial: "HP400G7-88K3A",
      quantity: 1,
      minStock: 1,
      location: "Almacén TI",
      assignedTo: "",
      status: "Disponible",
      notes: "Equipo listo para asignación.",
      updatedAt: new Date().toISOString(),
    },
    {
      id: crypto.randomUUID(),
      code: "MON-014",
      name: "Pantalla LG 24 pulgadas",
      type: "Activo",
      category: "Pantalla",
      brand: "LG",
      model: "24MK430",
      ...
      notes: "Requiere revisión de puerto HDMI.",
      updatedAt: new Date().toISOString(),
    },
    {
      id: crypto.randomUUID(),
      ...
      assignedTo: "",
      status: "Disponible",
      notes: "Uso general para monitores y televisores.",
      updatedAt: new Date().toISOString(),
    },
    {
      id: crypto.randomUUID(),
      ...
      assignedTo: "",
      status: "Agotado",
      notes: "Stock crítico para equipos con docking.",
      updatedAt: new Date().toISOString(),
    },
    {
      id: crypto.randomUUID(),
      code: "KEY-STD-08",
      name: "Teclado USB estándar",
      type: "Consumible",
      category: "Teclado",
      brand: "Logitech",
      model: "K120",
      ...
      assignedTo: "",
      status: "Disponible",
      notes: "Distribución por sucursal según necesidades.",
      updatedAt: new Date().toISOString(),
    },
  ],
  movements: [
    {
      ...
      type: "Asignación",
      quantity: 1,
      responsible: "Mariana López - Finanzas",
      destination: "Finanzas",
      notes: "Entrega de equipo principal.",
    },
    {
      id: crypto.randomUUID(),
      date: new Date().toISOString(),
      itemId: null,
      itemName: "Cable HDMI 2m",
      type: "Entrada",
      quantity: 8,
      responsible: "Almacén central",
      destination: "Almacén TI",
      notes: "Recepción de lote de insumos.",
    },
  ],
};
